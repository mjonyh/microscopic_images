% TikZ schematic: Filter Taxonomy
\begin{figure}[H]
\centering
\begin{tikzpicture}[
...
% Legend
\node[draw, fill=green!15, minimum width=1.5cm, minimum height=0.5cm, font=\footnotesize] (leg1) at (0,-3) {Recommended};
...
suitability for phase-contrast microscopy based on our evaluation.}
